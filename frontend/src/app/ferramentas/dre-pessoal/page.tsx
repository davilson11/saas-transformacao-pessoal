...
const PASSOS = [
  ...
  { numero: 2, label: "Receitas" },
  { numero: 3, label: "Despesas" },
  { numero: 4, label: "Diagnóstico" },
];
...
function CampoReais({
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200"
      ...
      <label style={{ flex: 1, fontSize: 13, fontWeight: 600, color: COR_DARK, fontFamily: "var(--font-body)" }}>
        {label}
      </label>
    ...
    <div className="flex flex-col rounded-2xl overflow-hidden" style={{ border: `1.5px solid ${cor}33`, background: "#fff", boxShadow: "var(--shadow-card)" }}>
      <div className="flex items-center justify-between px-5 py-4" style={{ background: `${cor}0e`, borderBottom: `1px solid ${cor}22` }}>
        ...
        <div className="flex items-center gap-1">
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--color-brand-gray)" }}>Total</span>
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 16, fontWeight: 700, color: cor, marginLeft: 6 }}>
            R$ {fmt(total)}
          </span>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col gap-1.5 rounded-xl px-4 py-3"
      ...
      <div className="flex items-center gap-2">
        ...
        <span style={{ fontSize: 13, fontWeight: 600, color: COR_DARK, flex: 1 }}>{label}</span>
        <div className="flex items-center gap-3">
...
export default function DREPessoalPage() {
  ...
  return (
    <div style={{ background: "#f7f5ee", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      {/* ── Topbar ── */}
      <div className="sticky top-0 z-20 flex items-center gap-4 px-6"
        style={{ height: 56, background: "#fff", borderBottom: "1px solid var(--color-brand-border)", boxShadow: "0 1px 8px rgba(30,57,42,0.06)" }}>
        <div className="flex items-center gap-2 flex-1" style={{ fontFamily: "var(--font-body)", fontSize: 13 }}>
          <Link href="/ferramentas" style={{ color: "var(--color-brand-gray)", textDecoration: "none" }}>Ferramentas</Link>
          <span style={{ color: "var(--color-brand-gray)" }}>›</span>
          <span style={{ color: COR_DARK, fontWeight: 600 }}>DRE Pessoal</span>
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 10, background: "rgba(224,165,95,0.15)", color: COR_GOLD, padding: "2px 8px", borderRadius: 99, fontWeight: 600, marginLeft: 4 }}>F07</span>
        </div>
        <div className="flex items-center gap-3">
          {mes !== undefined && (
            <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, fontWeight: 700, color: COR_DARK, background: `${COR_DARK}10`, padding: "3px 10px", borderRadius: 99 }}>
              {MESES[mes]}/{ANO_ATUAL}
            </span>
          )}
          {totalReceitas > 0 && (
            <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, fontWeight: 700, color: saldo >= 0 ? COR_GREEN : COR_RED, background: `${saldo >= 0 ? COR_GREEN : COR_RED}12`, padding: "3px 10px", borderRadius: 99 }}>
              {saldo >= 0 ? "+" : ""}R$ {fmt(saldo)}
            </span>
          )}
        </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex flex-col shrink-0 overflow-y-auto"
          style={{ width: 280, borderRight: "1px solid var(--color-brand-border)", background: "#fff", padding: "28px 20px", gap: 24 }}>
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2">
              <span style={{ fontSize: 22 }}>💰</span>
              <h2 style={{ fontFamily: "var(--font-heading)", fontSize: 17, fontWeight: 700, color: COR_DARK, lineHeight: 1.2 }}>DRE Pessoal</h2>
            </div>
            <p style={{ fontSize: 12, color: "var(--color-brand-gray)", lineHeight: 1.5, marginTop: 4 }}>
              Demonstrativo completo das suas finanças mensais.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 mt-auto">
            {passo < 3 ? (
              <button
                ...
                style={{
                  ...
                  cursor: podeAvancar() ? "pointer" : "not-allowed", border: "none",
                }}
              >
            ...
            {passo > 0 && (
              <button onClick={() => setPasso((p) => Math.max(0, p - 1))}
          ...
          {passo === 0 && (
            <div className="flex flex-col gap-8 max-w-2xl mx-auto">
              <div className="flex flex-col gap-3">
                <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, fontWeight: 600, color: COR_GOLD, textTransform: "uppercase", letterSpacing: "0.1em" }}>Ferramenta F07</span>
              ...
              <div className="rounded-2xl overflow-hidden" style={{ border: `1px solid ${COR_DARK}18` }}>
                <div className="px-5 py-4" style={{ background: COR_DARK }}>
                  ...
                  <p style={{ fontSize: 12, color: "rgba(244,241,222,0.6)", marginTop: 2 }}>Referência para uma distribuição saudável</p>
                </div>
                <div className="grid grid-cols-3 divide-x" style={{ borderColor: "var(--color-brand-border)" }}>
                  {[
                    ...
                    <div key={r.label} className="flex flex-col items-center gap-2 py-5 px-4 text-center">
                      ...
                      <span style={{ fontSize: 11, color: "var(--color-brand-gray)", lineHeight: 1.4 }}>{r.desc}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 rounded-xl p-4" style={{ background: `${COR_GOLD}12`, border: `1px solid ${COR_GOLD}33` }}>
                ...
                <div>
                  <p style={{ fontFamily: "var(--font-heading)", fontSize: 14, fontWeight: 700, color: COR_DARK }}>15–20 minutos</p>
                  <p style={{ fontSize: 12, color: "var(--color-brand-gray)" }}>Tenha seu extrato bancário e faturas de cartão em mãos.</p>
                </div>
              </div>
            </div>
          )}
              ...
              <SecaoFinanceira titulo="Investimentos" emoji="📈" cor={COR_BLUE} total={totalInvest}>
                ...
                {totalInvest === 0 && (
                  <div className="flex items-center gap-2 rounded-xl px-4 py-3"
                    ...
                    <p style={{ fontSize: 12, color: COR_BLUE, lineHeight: 1.5 }}>
            ...
            <div className="flex flex-col gap-6 max-w-2xl mx-auto">
              ...
              >
                <div className="flex flex-col gap-1 flex-1">
                  <span style={{ fontSize: 12, fontWeight: 600, color: "var(--color-brand-gray)", textTransform: "uppercase", letterSpacing: "0.06em" }}>
                    Saldo do Mês
                  </span>
              ...
              {totalReceitas > 0 && (
                <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid var(--color-brand-border)", background: "#fff", boxShadow: "var(--shadow-card)" }}>
                  <div className="px-5 py-4" style={{ borderBottom: "1px solid var(--color-brand-border)" }}>
                    ...
                    <p style={{ fontSize: 12, color: "var(--color-brand-gray)", marginTop: 2 }}>Renda total: R$ {fmt(totalReceitas)}</p>
                  </div>
                  {/* Barra composta */}
              ...
              <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid var(--color-brand-border)", background: "#fff", boxShadow: "var(--shadow-card)" }}>
                ...
                <div className="flex flex-col gap-3 p-5">
                  <p style={{ fontSize: 11, fontWeight: 600, color: "var(--color-brand-gray)", textTransform: "uppercase", letterSpacing: "0.06em" }}>Custos Fixos</p>
                  ...
                  <p style={{ fontSize: 11, fontWeight: 600, color: "var(--color-brand-gray)", textTransform: "uppercase", letterSpacing: "0.06em", marginTop: 8 }}>Custos Variáveis</p>
                  ...
                  <p style={{ fontSize: 11, fontWeight: 600, color: "var(--color-brand-gray)", textTransform: "uppercase", letterSpacing: "0.06em", marginTop: 8 }}>Investimentos</p>
        ...
        {/* ── Coluna Direita ── */}
        <div className="shrink-0 overflow-y-auto flex flex-col gap-5 p-6"
          ...
          <div className="flex flex-col rounded-2xl overflow-hidden"
            ...
            <div className="flex flex-col items-center justify-center py-6 gap-1">
              <span style={{ fontSize: 11, fontWeight: 600, color: "var(--color-brand-gray)", textTransform: "uppercase", letterSpacing: "0.07em" }}>Saldo</span>
              <span style={{
          ...
          <div className="flex flex-col gap-3">
            {[
              { label: "Receita Total", valor: totalReceitas, cor: COR_GREEN, emoji: "📥", pct: null },
              { label: "Total de Gastos", valor: totalGastos, cor: COR_RED, emoji: "📤", pct: pctGastos },
              { label: "Total Investido", valor: totalInvest, cor: COR_BLUE, emoji: "📈", pct: pctInvest },
            ].map((r) => (
              <div key={r.label} className="flex items-center gap-3 rounded-xl px-4 py-3"
                ...
                <div className="flex-1">
                  <p style={{ fontSize: 11, color: "var(--color-brand-gray)", lineHeight: 1 }}>{r.label}</p>
            ...
            <div className="flex flex-col gap-3 rounded-xl p-4" style={{ background: `${COR_DARK}06`, border: `1px solid ${COR_DARK}12` }}>
              ...
              {[
                ...
                <div key={r.label} className="flex flex-col gap-1">
                  <div className="flex items-center justify-between">
                    <span style={{ fontSize: 12, color: "var(--color-brand-gray)" }}>{r.label}</span>
                    <div className="flex items-center gap-1">
          ...
          {totalReceitas === 0 && totalGastos === 0 && (
            <div className="flex flex-col items-center gap-3 rounded-xl p-6 text-center" style={{ border: "1.5px dashed var(--color-brand-border)" }}>
              ...
              <p style={{ fontSize: 12, color: "var(--color-brand-gray)", lineHeight: 1.5 }}>Seu DRE vai aparecer aqui conforme você preenche.</p>
            </div>
          )}
        </div>
